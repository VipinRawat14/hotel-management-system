...
heading_label = tb.Label(heading_frame, text='HOTEL MANAGEMENT SYSTEM', font=('Arial 24 bold underline'),
...
status_entry = ttk.Combobox(input_frame, textvariable=status_var, values=["Checked In", "Checked Out"],
                            font=('Helvetica', 11))
...
# Create the treeview
treeview = tb.Treeview(treeview_frame, columns=['c1', 'c2', 'c3', 'c4', 'c5', 'c6', 'c7', 'c8'], show='headings',
                       bootstyle='dark', style='my.Treeview', height=7)
...
# Create the buttons
checkin_button = tb.Button(input_frame, text='CHECKIN', width=20, bootstyle="success,outline", takefocus=False,
                           command=addcust)
checkin_button.grid(row=1, column=0, padx=(0, 0), pady=(10, 10), ipadx=1, ipady=4)

checkout_button = tb.Button(input_frame, text='CHECKOUT', width=20, bootstyle="danger,outline", takefocus=False,
                            command=checkout)
...
delete_button = tb.Button(input_frame, text='DELETE CUSTOMER', width=20, bootstyle="outline", takefocus=False,
                          command=delete)
delete_button.grid(row=5, column=0, padx=(0, 0), pady=(10, 10), ipadx=1, ipady=4)

cancel_edit_button = tb.Button(input_frame, text='CANCEL EDIT', width=20, bootstyle="info,outline", takefocus=False,
                               command=cancel_edit)
